  ...
  return (
    <div className="chat_header">
      ...
      <div className="block_icon">
        { isCheck ? <span className="icon" >
        <FiUserCheck title="Chấp nhận lời mời kết bạn" onClick={() => handleAcceptFriend()} />
        </span> :  isFriend ? null : (
          <span className="icon" >
            {reqFriend ? (
              <FiUserX title="Hủy lời mời" onClick={() => handleCancleFriend()} />
            ) : (
              <FiUserPlus title="Gửi lời mời kết bạn" onClick={() => handleAddFriend()} />
            )}
          </span>
        )}
